...
void AGltfFullActor::ProcessNode(USceneComponent* NodeParentComponent, const FName SocketName, FglTFRuntimeNode& Node)
{
...
void AGltfFullActor::SetCurveAnimationByName(const FString& CurveAnimationName)
{
...
// Called every frame
void AGltfFullActor::Tick(float DeltaTime)
{
...
void AGltfFullActor::ReceiveOnStaticMeshComponentCreated_Implementation( UStaticMeshComponent *StaticMeshComponent, const FglTFRuntimeNode &Node) {
}

void AGltfFullActor::ReceiveOnSkeletalMeshComponentCreated_Implementation(USkeletalMeshComponent* SkeletalMeshComponent, const FglTFRuntimeNode& Node)
{  
}
